...
async function loadStateResults() {
    ...
    try {
        ...
        data.forEach((senator, index) => {
            ...
            headshotImg.src = senator["depiction"]["imageUrl"];
            ...
            nameLink.href = buildSenatorDetailUrl(state, senator.name);
            nameLink.textContent = senator.name;
            ...
            scoreDetails.appendChild(createDetailCard("Raw score", `${senator.score}/100`));
